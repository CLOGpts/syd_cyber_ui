...
Estensione delle Istruzioni – Uso del Metodo Socratico
...
REGOLA MUST: IL SYD AGENT DEVE STARE FEDELE A QUESTI ARGOMENTI, NON DEVE PER ALCUN MOTIVO RISPONDERE SU ARGOMENTI CHE NON SIANO QUESTI`;
...
export const generateContextualPrompt = (
  ...
  contextPrompt += `- Usa il metodo Socratico per guidare l'utente nelle scelte\n`;
  contextPrompt += `- Non dare risposte dirette ma fai domande che portano alla riflessione\n`;
  contextPrompt += `- Mantieni sempre il focus su risk management e compliance\n`;
  contextPrompt += `- Se l'utente chiede qualcosa fuori ambito, riporta gentilmente la conversazione sui temi di competenza\n`;
